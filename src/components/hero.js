      ...
      <div className="rounded-[100px] bg-[#E9F0FF] py-8 flex justify-between items-center">
        ...
        <div className="w-full pr-12 mx-20 space-y-5 lg:w-1/2">
          ...
          <div className="flex justify-start gap-5 text-base font-medium">
            <button className="hover:scale-105 px-5 py-3 text-white bg-[#4975E9] rounded-md font-semibold">
              Get 50% off SEO Plan
            </button>
            <button className="hover:scale-105 px-5 py-3 text-[#4975E9] border border-[#4975E9]  rounded-md font-semibold ">
