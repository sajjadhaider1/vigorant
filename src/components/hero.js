  ...
  return (
    <section className="my-6">
      <div className="rounded-[100px] bg-[#E9F0FF] py-28 flex justify-between items-center">
        <div className="bg-[#FF9F43] rounded-full h-[30px] w-[30px] fixed left-12 "></div>
        <div className="w-full mx-20 space-y-5 lg:w-1/2">
          <div className="text-6xl font-medium">
            Make your website load faster, optimize your images and boost your
            SEO.
          </div>
          <div className="text-xl font-medium text-[#697492]">
        ...
        <StaticImage
          className="fixed right-0 hidden lg:flex"
